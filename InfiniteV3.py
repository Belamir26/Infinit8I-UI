...
def aboutt():
    messagebox.showinfo("Hey there!",
                        "Desarrollado por Paul Benavides pybl2001@gmail.com\nMedellín, 2024.\nMIT Licence - Not distributed for commercial or medical use; research and education use encouraged."
                        )     
#Subfunciones
def plotDataAccel(i):
    global IMUACCEL
        ...
        if ser.in_waiting > 0:
            ...
            if len(data)==16:
                ...
                if elapsed_time % (rest_duration + action_duration) < rest_duration:
                    ...
                    data.append(int(imm[1])) #Este apend depende del combobox    
...
#FRAME 5
imagess=["IM\Protesis.jpg","IM\Sense.jpg","IM\Infinit.jpg"]
...
about =Button(frame4,command= aboutt, text= "About",bg="white",fg="black", font="Helvetica 4 bold",width=4,justify="center")
about.grid(row=4,column=0,  padx=20,pady=Ypaxy,columnspan=2)
